...
studiendekanat_validator = {
    "$jsonSchema": {
        ...
        "required": ["showstudiendekanat", "showstudienberatung", "showpruefungsamt", "name_de", "name_en", "link", "rolle_de", "rolle_en", "raum_de", "raum_en", "tel_de", "tel_en", "mail", "sprechstunde_de", "sprechstunde_en", "prefix_de", "prefix_en", "text_de", "text_en"],
        "properties": {
            "showstudiendekanat": {
                "bsonType": "bool",
