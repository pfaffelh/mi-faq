...
mongo_db.command('collMod','stu_qa', validator=schema20240815.studiendekanat_validator, validationLevel='off')
...
print("Check schema")
import schema20240815
mongo_db.command("collMod", "studiendekanat", validator = schema20240815.stu_qa_validator, validationLevel='moderate')
